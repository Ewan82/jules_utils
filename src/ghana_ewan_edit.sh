...
ncks -d lon,$lonmin,$lonmax -d lat,$latmin,$latmax $jules_dir/WFD\-EI\-LandFraction2d-2.nc $jules_dir/landfrac.regional.nc
ncks -d lon,$lonmin,$lonmax -d lat,$latmin,$latmax $jules_dir/qrparm.veg.frac2d-2.nc $jules_dir/vegfrac.regional.nc
ncks -d lon,$lonmin,$lonmax -d lat,$latmin,$latmax $jules_dir/qrparm.soil_HWSD_class3_van_genuchten2d_gh_update.nc $jules_dir/soil.regional.nc
ncks -d lon,$lonmin,$lonmax -d lat,$latmin,$latmax $jules_dir/WFDEI-long-lat-2d-2.nc $jules_dir/lonlat.regional.nc
